  ...
  const allProjects = [
    {
      ...
      projectImage:
        "https://github.com/BoraOzkoc/card-game/blob/main/Card-Game-SS.png?raw=true",
      projectIcons: [
    ...
    },
    {
      ...
      projectIcons: [
        <SiXcode key="xcode" size={16} />,
        <FaSwift key="swift" size={16} />,
      ],
    ...
    },
    {
      ...
      projectIcons: [
        <SiUnity key="unity" size={16} />,
        <TbBrandCSharp key="csharp" size={16} />,
      ],
      projectType: "Mobile Game",
      projectLink:
        "https://apps.apple.com/tr/app/merging-dragons/id6502720658?l=tr",
    },
    {
      projectName: "Reconstructed Rome",
      projectDescription: "A mobile game built with Unity and C#. It is a simulation game where you build variety of structures in Rome.",
      projectImage:
      ...
      projectType: "Mobile Game",
      projectLink:
        "https://apps.apple.com/tr/app/reconstructedrome/id6504153435?l=tr",
    },
  ];
